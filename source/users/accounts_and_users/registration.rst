...
Για να μπορέσετε να αποθηκεύσετε ή να επεξεργαστείτε κάποιο επίπεδο στην πλατφόρμα θα πρέπει να δημιουργήσετε ένα λογαριασμό χρήστη.

#. Από οποιαδήποτε σελίδα του Ιστοτόπου εντοπίστε, πάνω δεξιά, τον σύνδεσμο :guilabel:`Εγγραφή`. Κάντε κλικ σε αυτόν το σύνδεσμο και θα εμφανιστεί η φόρμα εγγραφής.
...
3. Η εγγραφή σας ολοκληρώθηκε με επιτυχία. Εισάγεται το όνομα χρήστη και τον κωδικό για να συνδεθείτε. Θα επιστρέψετε στην αρχική σελίδα.
