...
Σε αυτή την διεπαφή μπορείτε να αλλάξετε το στυλ των επιπέδων που φορτώθηκαν.
...
#. Αυτό το επίπεδο έχει ένα στυλ (που ονομάζεται *nurseryschools*) και ένα κανόνα. Κάντε κλικ στον κανόνα *Νηπιαγωγεία* για να τον επιλέξετε και, στη συνέχεια, κάντε κλικ στην επιλογή :guilabel:`Επεξεργασία` κάτω από αυτό.
